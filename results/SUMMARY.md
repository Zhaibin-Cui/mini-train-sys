...
[`single`](cloze/synbios_moe/single/full_100k/summary.json) and
[`multi5`](cloze/synbios_moe/multi5_permute/full_500k/summary.json).
...
Machine summary:
[`formal_20260724/summary.json`](probes/synbios_moe/comparisons/formal_20260724/summary.json).

## Mechanism follow-ups

| Diagnostic | Primary metric | Interpretation |
|---|---:|---|
...
| Single fresh P-whole + predicted `t1` | 44.23% → **56.47%** | modest unlock; position dependence remains |
| Multi5 fresh P-whole + predicted `t1` | 45.28% → **96.38%** | whole value becomes nearly linearly readable |
...
| TensorBoard events | [`catalog/tensorboard/index.csv`](catalog/tensorboard/index.csv) |
| Executed notebooks | [`benchmarks/notebooks/`](benchmarks/notebooks/) |
| Pretraining lineage | [`pretraining/synbios_moe/datasets/`](pretraining/synbios_moe/datasets/) |
| Probe-cache lineage | [`probes/synbios_moe/cache/`](probes/synbios_moe/cache/) |
