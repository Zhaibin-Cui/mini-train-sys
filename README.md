...
> `multi5_permute` 与正式 P/Q probe 尚未运行，不能把结构 smoke test 当作论文结果。
...
| `multi5_permute` 正式训练与比较 | **尚未运行** | 暂无 single vs. augmentation 对照结论 |

因此，当前最强结论是“训练有效并达到训练集原文的完全 recall”，不是“对新人物达到
100%”。后续论文对比必须完成 `multi5_permute` 训练、person-level held-out P/Q validation
